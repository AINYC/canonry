...
Generic [text routes](engine-routes.md) remain available for Aero and research.
They can provide answer text for mention measurement, but do not become sweep
providers through a model name or capability flag. Their citation state is
unavailable, not a measured citation miss.
