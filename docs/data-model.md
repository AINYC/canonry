...
| **measurement_plan_versions** | Immutable canonical Target-model revisions. A revision freezes Targets, optional groups, URL matchers, query snapshots, deduplicated execution nodes, and baseline/Target/group usage edges. | Unique: `(projectId, revision)` |
