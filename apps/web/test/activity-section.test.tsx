  ...
  const restoreFetch = mockFetch((url) => {
    ...
    if (urlPath.endsWith('/projects/test-project/ga/traffic')) {
      return jsonResponse({
        ...
        aiReferrals: [
          { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 12, users: 9 },
        ],
        aiReferralLandingPages: [
          { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', landingPage: '/pricing', sessions: 12, users: 9 },
        ],
  ...
  const restoreFetch = mockFetch((url) => {
    ...
    if (urlPath.endsWith('/projects/test-project/ga/traffic')) {
      return jsonResponse({
        ...
        aiReferrals: [
          { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 12, users: 9 },
          { source: 'claude.ai', medium: 'referral', trafficClass: 'organic', sourceDimension: 'first_user', sessions: 30, users: 24 },
        ],
        aiReferralLandingPages: [
          { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', landingPage: '/pricing', sessions: 12, users: 9 },
          { source: 'claude.ai', medium: 'referral', trafficClass: 'organic', sourceDimension: 'first_user', landingPage: '/guide', sessions: 30, users: 24 },
        ],
