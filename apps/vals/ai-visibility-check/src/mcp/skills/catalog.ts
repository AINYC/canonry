...
import { part as aeroSkillPart0 } from './aero-skill.0.ts'
import { part as aeroReferencesAeoDiscoveryPart0 } from './aero-references-aeo-discovery.0.ts'
import { part as aeroReferencesMemoryPatternsPart0 } from './aero-references-memory-patterns.0.ts'
import { part as aeroReferencesOrchestrationPart0 } from './aero-references-orchestration.0.ts'
import { part as aeroReferencesRegressionPlaybookPart0 } from './aero-references-regression-playbook.0.ts'
import { part as aeroReferencesReportingPart0 } from './aero-references-reporting.0.ts'
import { part as aeroReferencesWordpressElementorMcpPart0 } from './aero-references-wordpress-elementor-mcp.0.ts'
import { part as aeroSoulPart0 } from './aero-soul.0.ts'
import { part as canonrySkillPart0 } from './canonry-skill.0.ts'
import { part as canonryReferencesAeoAnalysisPart0 } from './canonry-references-aeo-analysis.0.ts'
import { part as canonryReferencesCanonryCliPart0 } from './canonry-references-canonry-cli.0.ts'
import { part as canonryReferencesCanonryCliPart1 } from './canonry-references-canonry-cli.1.ts'
import { part as canonryReferencesGoogleBusinessProfilePart0 } from './canonry-references-google-business-profile.0.ts'
import { part as canonryReferencesGoogleMarketingPart0 } from './canonry-references-google-marketing.0.ts'
import { part as canonryReferencesIndexingPart0 } from './canonry-references-indexing.0.ts'
import { part as canonryReferencesServerSideTrafficPart0 } from './canonry-references-server-side-traffic.0.ts'
import { part as canonryReferencesWordpressIntegrationPart0 } from './canonry-references-wordpress-integration.0.ts'
