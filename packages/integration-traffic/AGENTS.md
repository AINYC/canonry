...
| `src/ip-range-manifest.ts` | Strict, full-string IPv4/IPv6/CIDR parsing plus pure publisher-manifest validation. The refresh script and runtime verifier share this fail-closed boundary. |
