...
export const MCP_OPENAPI_OPERATION_CLASSIFICATIONS = {
  ...
  'GET /api/v1/projects/{name}/google/gsc/platform-properties': 'included',
  'PUT /api/v1/projects/{name}/google/gsc/platform-properties': 'included',
  'DELETE /api/v1/projects/{name}/google/gsc/platform-properties/{id}': 'included',
  'POST /api/v1/projects/{name}/google/gsc/platform-properties/{id}/sync': 'included',
  'GET /api/v1/projects/{name}/google/gsc/platform-performance': 'included',
