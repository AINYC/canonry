...
export const MCP_OPENAPI_OPERATION_CLASSIFICATIONS = {
  ...
  // Advanced Measurement v2. The routes are registered and typed, but their
  // handlers answer 501 until the slice that owns each module lands, so an MCP
  // tool over them would only teach an agent to call something that cannot
  // work. Promote each to 'included' with its handler.
  'GET /api/v1/projects/{name}/measurement-setup': 'deferred',
  'GET /api/v1/projects/{name}/measurement-plan/draft': 'deferred',
  'GET /api/v1/projects/{name}/measurement-plan/draft/targets': 'deferred',
  'GET /api/v1/projects/{name}/measurement-plan/draft/assignments': 'deferred',
  'GET /api/v1/projects/{name}/measurement-plan/draft/groups': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/create': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/import-sitemap': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/apply-sitemap-selection': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/upsert-target': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/rename-target': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/merge-targets': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/exclude-target': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/rebind-target': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/apply-assignments': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/remove-assignment': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/clear-assignments': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/classify-assignments': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/upsert-group': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/remove-group': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/upsert-competitor': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/remove-competitor': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/compile-preview': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/diff-preview': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/publish': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/draft/actions/discard': 'deferred',
  'POST /api/v1/projects/{name}/measurement-plan/actions/deactivate': 'deferred',
  'GET /api/v1/projects/{name}/measurement-overview': 'deferred',
  'GET /api/v1/projects/{name}/measurement-query-sets': 'deferred',
  'GET /api/v1/projects/{name}/measurement-query-sets/{setId}': 'deferred',
  'PUT /api/v1/projects/{name}/measurement-query-sets/{setId}': 'deferred',
  'DELETE /api/v1/projects/{name}/measurement-query-sets/{setId}': 'deferred',
  'GET /api/v1/projects/{name}/measurement-query-templates': 'deferred',
  'PUT /api/v1/projects/{name}/measurement-query-templates/{templateId}': 'deferred',
  'DELETE /api/v1/projects/{name}/measurement-query-templates/{templateId}': 'deferred',
  'POST /api/v1/projects/{name}/measurement-query-templates/{templateId}/apply': 'deferred',
