...
export const MCP_OPENAPI_OPERATION_CLASSIFICATIONS = {
  ...
  // Keep every new OpenAPI operation classified in the same layer as its API.
  // Agent tools are added separately; until then, the provider and contract
  // surface remains deliberate API/CLI-only functionality.
  'GET /api/v1/projects/{name}/google-ads/status': 'deferred',
  'GET /api/v1/projects/{name}/gtm/status': 'deferred',
  ...
  'GET /api/v1/projects/{name}/google-ads/customers': 'deferred',
  'GET /api/v1/projects/{name}/gtm/accounts': 'deferred',
  'GET /api/v1/projects/{name}/gtm/accounts/{accountId}/containers': 'deferred',
  'GET /api/v1/projects/{name}/gtm/accounts/{accountId}/containers/{containerId}/workspaces': 'deferred',
  'PUT /api/v1/projects/{name}/google-ads/selection': 'deferred',
  'PUT /api/v1/projects/{name}/gtm/selection': 'deferred',
  'POST /api/v1/projects/{name}/google-ads/sync': 'deferred',
  'POST /api/v1/projects/{name}/gtm/sync': 'deferred',
  'GET /api/v1/projects/{name}/google-ads/snapshots': 'deferred',
  'GET /api/v1/projects/{name}/google-ads/snapshots/{snapshotId}': 'deferred',
  'GET /api/v1/projects/{name}/gtm/snapshots': 'deferred',
  'GET /api/v1/projects/{name}/gtm/snapshots/{snapshotId}': 'deferred',
  'DELETE /api/v1/projects/{name}/google-ads/connection': 'deferred',
  'DELETE /api/v1/projects/{name}/gtm/connection': 'deferred',
  'GET /api/v1/projects/{name}/conversion-tracking/contracts': 'deferred',
  'POST /api/v1/projects/{name}/conversion-tracking/contracts': 'deferred',
  'GET /api/v1/projects/{name}/conversion-tracking/contracts/{contractId}': 'deferred',
  ...
  'GET /api/v1/projects/{name}/conversion-tracking/contracts/{contractId}/integrity': 'deferred',
