...
| `src/mcp/tool-registry.ts` | All 153 API tools, including sitemap Target discovery and revision-pinned measurement reports, each tagged with a `tier` (`core` or one of the toolkit names) |
