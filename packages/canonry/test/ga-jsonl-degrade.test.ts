...
const TRAFFIC_DTO = {
  ...
  organicAiSharePctBySessionDisplay: '5%',
  ...
  aiReferrals: [
    { source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 5 },
  ],
  aiReferralLandingPages: [
    { landingPage: '/pricing', source: 'chatgpt.com', medium: 'referral', trafficClass: 'organic', sourceDimension: 'session', sessions: 12 },
  ],
  socialReferrals: [
    { source: 'reddit.com', medium: 'referral', channelGroup: 'Organic Social', sessions: 8, users: 6 },
  ],
  topPages: [
    { landingPage: '/', sessions: 50, organicSessions: 10, directSessions: 15, users: 40 },
  ],
