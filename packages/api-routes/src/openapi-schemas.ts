...
const SCHEMA_TABLE = {
  ...
  GscPlatformPropertyDto: gscPlatformPropertyDtoSchema,
  GscPlatformPropertyListResponseDto: gscPlatformPropertyListResponseDtoSchema,
  GscPlatformPropertyUpsertRequestDto: gscPlatformPropertyUpsertRequestDtoSchema,
  GscPlatformPerformanceDto: gscPlatformPerformanceDtoSchema,
