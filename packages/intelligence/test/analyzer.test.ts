...
describe('analyzeRuns', () => {
  ...
  it('attaches competitor cause analysis to regression insights', () => {
    ...
    const curr = makeRun({
      runId: 'run_002',
      snapshots: [
        { query: 'k1', provider: 'chatgpt', cited: false, citedCompetitorDomains: ['rival.com'] },
      ],
    })
  ...
  it('emits first-citation, provider-pickup, persistent-gap, and competitor signals when configured', () => {
    ...
    const r3 = makeRun({
      ...
      snapshots: [
        ...
        { query: 'k5', provider: 'chatgpt', cited: false, citedCompetitorDomains: ['rival.com'] },
      ],
    })
  ...
  it('skips competitor signals when no competitors are tracked', () => {
    const r1 = makeRun({ runId: 'r1', snapshots: [{ query: 'k1', provider: 'chatgpt', cited: false, citedCompetitorDomains: ['rival.com'] }] })
    const r2 = makeRun({ runId: 'r2', snapshots: [{ query: 'k1', provider: 'chatgpt', cited: false }] })
