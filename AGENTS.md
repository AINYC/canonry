...
a parallel surface. v1 exposes 139 curated API tools (88 read, 51 write) — including
...
- `packages/canonry/src/mcp/tool-registry.ts` — single source of truth for all 139 API tools, each tagged with a `tier`
